...
import AccountMenuDropdownLoader from "./AccountMenuDropdownLoader.vue";
...
export default defineComponent({
    ...
    components: {
        Icon,
        AccountMenuDropdown: defineAsyncComponent({
            loader: () => import("./AccountMenuDropdown.vue"),
            loadingComponent: AccountMenuDropdownLoader,
        }),
    },
    setup() {
        ...
        return { isOpen, toggleMenu, closeMenu, mdiAccountOutline };
    },
});
</script>
